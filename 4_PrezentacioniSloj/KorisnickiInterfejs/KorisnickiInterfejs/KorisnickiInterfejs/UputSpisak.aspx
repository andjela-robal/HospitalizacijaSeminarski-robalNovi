<%@ Page Title="Spisak Uputa" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="UputSpisak.aspx.cs" Inherits="KorisnickiInterfejs.UputSpisak" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        <td class="style1">
            &nbsp;</td>
        <td class="style2">
            <asp:GridView ID="gvUputi" runat="server" Height="199px" Width="484px">
            </asp:GridView>
        </td>
        <td>
            &nbsp;</td>
